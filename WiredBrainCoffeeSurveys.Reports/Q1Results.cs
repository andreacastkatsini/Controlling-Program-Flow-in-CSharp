    ...
    public static class Q1Results
    {
        ...
        public static List<SurveyResponse> Responses = new List<SurveyResponse>()
        {
            ...
            new SurveyResponse()
            {
                ...
                LeastFavoriteProduct = "Fruit",
                WouldRecommend = 4.0,
                Comments = "The pickup area should be by the door.",
            },
            new SurveyResponse()
            {
                ...
                LeastFavoriteProduct = "Fruit",
                WouldRecommend = 6.0,
                Comments = "I like the stores but you coffee is too expensive",
            },
            new SurveyResponse()
            {
            ...
            new SurveyResponse()
            {
                ...
                LeastFavoriteProduct = "Fruit",
                WouldRecommend = 6.5,
                Comments = "Your prices are so high.",
            },
            new SurveyResponse()
            {
                ...
                LeastFavoriteProduct = "Fruit",
                WouldRecommend = 7.5,
                Comments = "MobileApp doesn´t work.",
            },
        };
    }
}
